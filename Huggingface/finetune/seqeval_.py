...
class Seqeval(datasets.Metric):
    ...
    def _compute(self, predictions, references, suffix=False):
        report = classification_report(y_true=references, y_pred=predictions, suffix=suffix, output_dict=True, zero_division=1)
        report.pop("micro avg")
        # todo:  following previous work.  here we used macro f1.
        report.pop("weighted avg")
        # todo 这里使用的是 macro avg
